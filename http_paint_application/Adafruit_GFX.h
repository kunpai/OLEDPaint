...
//    void fillScreen(unsigned int color);
  ...
  // These exist only with Adafruit_GFX (no subclass overrides)
    ...
    void fillCircleHelperCursor(int x0, int y0, int r, unsigned char cornername, int delta);
    ...
    void drawQuad(int x0, int y0, int x1, int y1, int x2, int y2, int x3, int y3, unsigned int color);
